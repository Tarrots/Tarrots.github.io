...
<title><dec:title default="Home Version One || limupa - Digital Products Store
	eCommerce Bootstrap 4 Template" /></title>
<meta name="description" content="">
<meta name="viewport" content="width=device-width, initial-scale=1">
<!-- Favicon -->
<link rel="shortcut icon" type="image/x-icon"
	href="<c:url value='./template/web/images/favicon.png' />">
<!-- Gắn link vào file jsp -->

<!-- Material Design Iconic Font-V2.2.0 -->
<link rel="stylesheet"
	href="<c:url value='./template/web/css/material-design-iconic-font.min.css' />">
<!-- Font Awesome -->
<link rel="stylesheet"
	href="<c:url value='./template/web/css/font-awesome.min.css' />">
<!-- Font Awesome Stars-->
<link rel="stylesheet"
	href="<c:url value='./template/web/css/fontawesome-stars.css' />">
<!-- Meanmenu CSS -->
<link rel="stylesheet"
...
<!-- Venobox CSS -->
<link rel="stylesheet"
	href="<c:url value='./template/web/css/venobox.css' />">
<!-- Nice Select CSS -->
<link rel="stylesheet"
					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4">
							<div class="header-top-left">
								<ul class="phone-wrap">
									<li><span>Telephone Enquiry:</span><a href="#">(+123)
											123 321 345</a></li>
								</ul>
							</div>
						</div>
										...
										<div class="language ht-language">
											<ul class="ht-setting-list">
												<li class="active"><a href="#"><img
														src="<c:url value='./template/web/images/menu/flag-icon/1.jpg' />"
														alt="">English</a></li>
												<li><a href="#"><img
														src="<c:url value='./template/web/images/menu/flag-icon/2.jpg' />"
														alt="">Français</a></li>
											</ul>
										</div></li>
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<div class="logo pb-sm-30 pb-xs-30">
								<a href="index.html"> <img src="<c:url value='./template/web/images/menu/logo/1.jpg' />"
									alt="Trang chủ">
								</a>
							</div>
						</div>
								...
								<ul class="hm-menu">
									...
									<li class="hm-minicart">
										<div class="hm-minicart-trigger">
											<span class="item-icon"></span> <span class="item-text">£80.00
											...
											<ul class="minicart-product-list">
												<li><a href="single-product.html"
													class="minicart-product-image"> <img
														src="<c:url value='./template/web/images/product/small-size/5.jpg' />" alt="cart products">
												</a>
												...
												<li><a href="single-product.html"
													class="minicart-product-image"> <img
														src="<c:url value='./template/web/images/product/small-size/6.jpg' />" alt="cart products">
												</a>
													<div class="minicart-product-details">
														<h6>
															<a href="single-product.html">Aenean eu tristique</a>
									...
									<ul>
										...
										<li class="megamenu-holder"><a
											...
											<ul class="megamenu hb-megamenu">
												<li><a href="shop-left-sidebar.html">Shop Page
														Layout</a>
													<ul>
												...
												<li><a href="single-product-gallery-left.html">Single
													...
													<ul>
														<li><a href="single-product-carousel.html">Single
																Product Carousel</a></li>
														<li><a href="single-product-gallery-left.html">Single
																Product Gallery Left</a></li>
														...
														<li><a href="single-product-tab-style-top.html">Single
																Product Tab Style Top</a></li>
														<li><a href="single-product-tab-style-left.html">Single
																Product Tab Style Left</a></li>
												...
												<li><a href="single-product.html">Single Products</a>
													<ul>
														...
														<li><a href="single-product-group.html">Single
																Product Group</a></li>
														<li><a href="single-product-normal.html">Single
																Product Normal</a></li>
										...
										<li class="dropdown-holder"><a
											href="blog-left-sidebar.html">Blog</a>
											<ul class="hb-dropdown">
												<li class="sub-dropdown-holder"><a
													href="blog-left-sidebar.html">Blog Grid View</a>
												...
												<li class="sub-dropdown-holder"><a
													...
													<ul class="hb-dropdown hb-sub-dropdown">
														...
														<li><a href="blog-video-format.html">Blog Video
																Format</a></li>
														<li><a href="blog-gallery-format.html">Blog
																Gallery Format</a></li>
													</ul></li>
											</ul></li>
