			...
			<div class="footer-shipping pt-60 pb-55 pb-xs-25">
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
						<div class="li-shipping-inner-box">
							<div class="shipping-icon">
								<img src="<c:url value='./template/web/images/shipping-icon/1.png' />" alt="Shipping Icon">
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
						<div class="li-shipping-inner-box">
							<div class="shipping-icon">
								<img src="<c:url value='./template/web/images/shipping-icon/2.png' />" alt="Shipping Icon">
							</div>
							<div class="shipping-text">
								<h2>Safe Payment</h2>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
						<div class="li-shipping-inner-box">
							<div class="shipping-icon">
								<img src="<c:url value='./template/web/images/shipping-icon/3.png' />" alt="Shipping Icon">
							</div>
							<div class="shipping-text">
					...
					<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
						<div class="li-shipping-inner-box">
							<div class="shipping-icon">
								<img src="<c:url value='./template/web/images/shipping-icon/4.png'/>" alt="Shipping Icon">
							</div>
							<div class="shipping-text">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="footer-logo">
							<img src="<c:url value='./template/web/images/menu/logo/1.jpg'/>" alt="Footer Logo">
						...
						<ul class="des">
							...
							<li><span>Phone: </span> <a href="#">(+123) 123 321 345</a>
							</li>
						...
						<div class="footer-block">
							...
							<ul class="social-link">
								...
								<li class="google-plus"><a
									...
									data-toggle="tooltip" target="_blank" title="Google Plus">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="copyright text-center">
						<a href="#"> <img src="<c:url value='./template/web/images/payment/1.png'/>" alt="">
						</a>
					</div>
					...
					<div class="col-lg-5 col-md-6 col-sm-6">
						...
						<div class="product-details-left">
							<div class="product-details-images slider-navigation-1">
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/1.jpg'/>" alt="product image">
								</div>
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/2.jpg'/>" alt="product image">
								</div>
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/3.jpg'/>" alt="product image">
								</div>
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/4.jpg'/>" alt="product image">
								</div>
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/5.jpg'/>" alt="product image">
								</div>
								<div class="lg-image">
									<img src="<c:url value='./template/web/images/product/large-size/6.jpg'/>" alt="product image">
								</div>
							</div>
							<div class="product-details-thumbs slider-thumbs-1">
								<div class="sm-image">
									<img src="<c:url value='./template/web/images/product/small-size/1.jpg'/>"
										alt="product image thumb">
								</div>
								<div class="sm-image">
									<img src="<c:url value='./template/web/images/product/small-size/2.jpg'/>"
										alt="product image thumb">
								</div>
								<div class="sm-image">
									<img src="<c:url value='./template/web/images/product/small-size/3.jpg'/>"
										alt="product image thumb">
								</div>
								<div class="sm-image">
									<img src="<c:url value ='./template/web/images/product/small-size/4.jpg'/>"
										alt="product image thumb">
								</div>
								<div class="sm-image">
									<img src="<c:url value='./template/web/images/product/small-size/5.jpg'/>"
										alt="product image thumb">
								</div>
								<div class="sm-image">
									<img src="<c:url value='./template/web/images/product/small-size/6.jpg'/>"
										alt="product image thumb">
								</div>
							</div>
						</div>
...
<!-- Popper js -->
<script src="<c:url value='./template/web/js/vendor/popper.min.js'/>"></script>
...
<!-- Imagesloaded js -->
<script src="<c:url value='./template/web/js/imagesloaded.pkgd.min.js'/>"></script>
<!-- Mixitup js -->
<script src="<c:url value='./template/web/js/jquery.mixitup.min.js'/>"></script>
<!-- Countdown -->
...
<!-- Barrating -->
<script src="<c:url value='./template/web/js/jquery.barrating.min.js'/>"></script>
<!-- Jquery-ui -->
<script src="<c:url value='./template/web/js/jquery-ui.min.js'/>"></script>
<!-- Venobox -->
<script src="<c:url value='./template/web/js/venobox.min.js'/>"></script>
<!-- Nice Select js -->
<script src="<c:url value='./template/web/js/jquery.nice-select.min.js'/>"></script>
<!-- ScrollUp js -->
<script src="<c:url value='./template/web/js/scrollUp.min.js'/>"></script>
<!-- Main/Activator js -->
